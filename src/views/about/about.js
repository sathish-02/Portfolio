  ...
  return (
    <Box>
      ...
      <Box pt={{ base: "40px", md: "80px", xl: "80px" }}>
              ...
              <Box __css={styles} border="none" bg="transparent">
                ...
                <SimpleGrid columns="2" gap="20px">
                  ...
                  <AboutMeInfo
                    boxShadow={cardShadow}
                    title="Education"
                    value="BE Civil engineering, Chennai "
                  />
                  <AboutMeInfo
                    boxShadow={cardShadow}
                    title="Degree"
        ...
        {/* <Flex justifyContent="center" alignItems="center" mt="20px">
          ...
          >
            <LazyLoadImage
              src={
                colorMode === "light"
                  ? "https://github-readme-streak-stats.herokuapp.com?user=sathish-02&theme=whatsapp-light&hide_border=true&border_radius=5.8&date_format=j%20M%5B%20Y%5D"
                  : "https://github-readme-streak-stats.herokuapp.com?user=sathish-02&theme=calm-pink&hide_border=true&border_radius=5.8&date_format=j%20M%5B%20Y%5D"
              }
              alt="GitHub Streak"
              effect="blur"
        ...
        <Flex justifyContent="center" alignItems="center" mt="20px">
          <Link href="https://github.com/sathish-02" target="blank">
